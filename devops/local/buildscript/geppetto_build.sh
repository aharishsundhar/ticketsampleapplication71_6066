...
APPLICATION='/ticketsampleapplication71'
...
DESKTOPIMAGENAME='geppettotest/ticketsampleapplication71-desktop:1.0'
...
helm install --name ticketsampleapplication71-6066 ./helm
if [ $? -eq 0 ]; then
